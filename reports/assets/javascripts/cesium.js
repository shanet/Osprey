...
function initCesium() {
  ...
  // Convert the coordinates to the format required by the terrain sampler
  var points = [];
  ...
  Cesium.sampleTerrain(terrainProvider, 9, points).then(function(updatedPositions) {
    ...
    viewer.dataSources.add(Cesium.CzmlDataSource.load(getCzmlLine())).then(function(ds) {
